...
/// </summary>
[LmpSignature("""
    Classify the customer's banking query into exactly one of these 77 intent categories.
    Return the exact label string.

    Valid intents: activate_my_card, age_limit, apple_pay_or_google_pay, atm_support,
